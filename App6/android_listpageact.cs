...
namespace App6
{
    [Activity(Label = "android_listpageact")]
    public class android_listpageact : Activity
    {

        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.android_listpage);


            string strUrl = "https://www.youtube.com/embed/dFlPARW5IX8";
